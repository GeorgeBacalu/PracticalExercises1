...
public class CheckingAccountTest
{
    ...
    public CheckingAccountTest() => _initialBalance = (_account = AccountMock.CheckingAccountMock()).Balance;
    ...
    {
        bool result = _account.Withdraw(AccountMock.WithdrawAmountOverLimitChecking, out var error);
