        ...
        while (true)
        {
            try
            {
                if (!AuthService.IsAuthenticated)
                {
                    ...
                    switch (option)
                    {
                        case 1: await AuthService.RegisterAsync(); break;
                ...
                else
                {
                    ...
                    switch (option)
                    {
                        ...
                        case 2: await AccountRegistry.CreateAccountAsync(); break;
                        case 3: await AccountRegistry.DepositAsync(); break;
                        case 4: await AccountRegistry.WithdrawAsync(); break;
                        case 5: await AccountRegistry.ViewStatementAsync(); break;
                        case 6: await AccountRegistry.RunMonthEndProcessingAsync(); break;
                        case 7: await AccountRegistry.TransferAsync(); break;
            ...
            {
                await Console.Out.WriteAsync("Press any key to continue");
                Console.ReadKey();
                Console.Clear();
            }
        }
